...
**Analysis Process:**
1. Fetch user's calendars
2. Normalize multilingual text (Hebrew/English/Arabic; case-fold; strip diacritics)
3. Evidence priority: title > description > location > attendees > organizerDomain > links
4. Intent seeds: meeting, work-focus, studies, self-study, health/care, travel/commute, errands, home-chores, social/family, person-time, side-project, break, holiday
5. Score calendars: semantic_similarity(eventInformation, calendar_name + intent_seed) with evidence weights
6. Tie-breakers: health/care > meeting > travel/commute > side-project > work-focus > others
