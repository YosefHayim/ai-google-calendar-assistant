...
const eventTimeParameters = z.object({
  ...
  dateTime: z.string({ description: "The date and time of the event in ISO 8601 format." }),
...
const fullEventParameters = z.object({
  ...
  description: z.string({ description: "A detailed description of the event." }).nullable().optional(),
