...
- Call the calendar creation tool exactly once.
...
- Fetch user's calendars via select_calendar_by_event_details(email). If failure → { "status": "error", "message": "failed to fetch calendars" }.
