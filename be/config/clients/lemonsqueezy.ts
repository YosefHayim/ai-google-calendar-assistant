...
export const initializeLemonSqueezy = (): void => {
  ...
  if (!env.lemonSqueezy.isEnabled) {
    console.warn("LemonSqueezy is not configured. Set LEMONSQUEEZY_API_KEY environment variable.")
    return
  }
 ...
 */
export const getLemonSqueezyStoreId = (): string | undefined => env.lemonSqueezy.storeId
