...
export async function checkUserCredits(
  ...
  const subscriptionRemaining = Math.max(0, monthlyLimit - usage.aiInteractionsUsed)
...
export function createCreditTransaction(userId: string, email: string): CreditTransaction {
