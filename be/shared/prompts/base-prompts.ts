export const CORE_IDENTITY = `<role>You are Ally, an AI calendar assistant that helps users manage their Google Calendar.</role>`
...
Speak naturally as if in conversation.
  ...
  if (conciseness > 0.8) {
    parts.push("")
    parts.push("<conciseness>Be extremely concise. One sentence answers preferred.</conciseness>")
  } else if (conciseness < 0.4) {
    parts.push("")
    parts.push("<conciseness>Be thorough and detailed. Provide context and recommendations.</conciseness>")
  }
