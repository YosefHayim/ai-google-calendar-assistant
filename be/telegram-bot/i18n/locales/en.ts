export const en = {
  "commands.start.header": "Welcome to Ally",
  ...
  "commands.help.sections.viewSchedule.items.5": "/busy - View commitments",
  "commands.help.sections.manageEvents.title": "Manage Events",
  "commands.help.sections.manageEvents.items.0": "/create - Schedule something",
  ...
  "commands.exit.footer": "Go get things done",
  ...
  "commands.tomorrow.footerTip": "Stay ahead - plan your day the night before.",

  "commands.week.header": "Week at a Glance",
  "commands.week.text": "Fetching your 7-day overview...",
  "commands.week.footerTip": "A well-planned week means more deep work time.",

  "commands.month.header": "Monthly Overview",
  "commands.month.text": "Fetching your calendar for this month...",
  "commands.month.footerTip": "Use /analytics for time insights and trends.",

  "commands.free.header": "Finding Open Slots",
  "commands.free.text": "Scanning your schedule for availability...",
  "commands.free.alsoAskText": "You can also ask:",
  "commands.free.suggestions.0": "'When am I free this week?'",
  "commands.free.suggestions.1": "'Find me 2 hours for deep work'",
  "commands.free.suggestions.2": "'What's my next open slot?'",

  "commands.busy.header": "Your Commitments",
  "commands.busy.text": "Checking when you're booked...",
  "commands.busy.footerTip": "Use /free to find open slots instead.",

  "commands.quick.header": "Quick Add",
  "commands.quick.text": "Just tell me what to schedule:",
  "commands.quick.examples.0": "'Call with Sarah at 3pm'",
  "commands.quick.examples.1": "'Lunch tomorrow at noon'",
  "commands.quick.examples.2": "'Block Friday afternoon for focus time'",
  ...
  "commands.cancel.examples.0": "'Cancel my 3pm meeting'",
  "commands.cancel.examples.1": "'Push tomorrow's call to next week'",
  "commands.cancel.examples.2": "'Clear my Friday afternoon'",
  "commands.cancel.footer": "I'll handle the updates for you.",

  "commands.search.header": "Search Calendar",
  ...
  "commands.remind.header": "Set a Reminder",
  "commands.remind.text": "Never miss what matters. Try:",
  "commands.remind.examples.0": "'Remind me to call John at 5pm'",
  "commands.remind.examples.1": "'Set a reminder for tomorrow morning'",
  "commands.remind.examples.2": "'Remind me 30 min before my next meeting'",
  "commands.remind.footer": "I've got you covered",

  "commands.analytics.header": "Time Insights",
  "commands.analytics.text": "Understand how you spend your time:",
  "commands.analytics.footerTip": "I'll show you where your time is going.",
  "commands.analytics.sections.timePeriod.title": "Time Period",
  "commands.analytics.sections.timePeriod.items.0": "'Insights for today'",
  "commands.analytics.sections.timePeriod.items.1": "'Insights for this week'",
  ...
  "commands.status.checkingItems.0": "Google Calendar: Verifying...",
  "commands.status.footerTip": "Having issues? Try /settings to reconnect.",

  "commands.settings.header": "Ally Settings",
  ...
  "commands.language.currentLanguageText": "Current language:",
  "commands.language.selectPrompt": "Select your preferred language:",
  "commands.language.changedText": "Language changed to",
  "commands.language.languages.en": "English",
  "commands.language.languages.he": "Hebrew (עברית)",
  ...
  "errors.eventCreationError": "Error creating the event. Please try again.",
  ...
  "botMenu.week": "Week at a glance",
  "botMenu.month": "Monthly overview",
  "botMenu.free": "Find open slots",
  "botMenu.busy": "View commitments",
  "botMenu.create": "Schedule something",
  "botMenu.update": "Reschedule or edit",
  "botMenu.delete": "Cancel an event",
  "botMenu.search": "Search calendar",
  "botMenu.analytics": "Time insights",
  "botMenu.calendars": "Your calendars",
  "botMenu.status": "Check connection",
  "botMenu.settings": "Ally settings",
  "botMenu.help": "How Ally helps",
