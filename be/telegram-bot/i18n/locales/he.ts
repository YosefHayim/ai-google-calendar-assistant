export const he = {
  ...
  "auth.googleCalendarMissingPermissions":
    "⚠️ <b>נדרשות הרשאות נוספות</b>\n\nאני צריכה גישה מלאה ליומן כדי לעזור לך ביעילות. אנא התחבר מחדש עם הרשאות מלאות.",
  "auth.googleCalendarSessionExpired":
    "🔄 <b>פג תוקף ההתחברות</b>\n\nההתחברות שלך ליומן Google פגה. אנא התחבר מחדש כדי להמשיך.",
  "auth.googleCalendarConnectButton": "🔗 חבר יומן Google",
  "auth.googleCalendarReconnectButton": "🔄 התחבר מחדש ליומן Google",
  ...
  "commands.reschedule.failed": "התזמון מחדש נכשל",
  "commands.reschedule.error": "משהו השתבש. אנא נסה שוב.",
  "commands.reschedule.unknownError": "לא ניתן לתזמן מחדש את האירוע.",
  "commands.reschedule.noSession": "אין תזמון מחדש פעיל. השתמש ב-/reschedule.",
  "commands.reschedule.invalidSelection": "בחירה לא תקינה. אנא נסה שוב.",
  "commands.reschedule.applying": "מתזמן מחדש...",
  "commands.reschedule.cancelled": "התזמון מחדש בוטל.",
  "commands.reschedule.cancelledHeader": "בוטל",
