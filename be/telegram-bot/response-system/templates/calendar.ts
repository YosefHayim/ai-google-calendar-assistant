 ...
 */
export function weeklyCalendarTemplate(
 ...
 */
export function todayScheduleTemplate(
 ...
 */
export function tomorrowScheduleTemplate(
  schedule: DaySchedule,
  userName?: string
): ResponseBuilder {
 ...
 */
export function freeTimeTemplate(
  slots: Array<{ start: Date | string; end: Date | string }>,
  period = "today"
): ResponseBuilder {
  const builder = ResponseBuilder.telegram()
    .type("info")
 ...
 */
export function busyTimeTemplate(
  events: CalendarEvent[],
  period = "today"
): ResponseBuilder {
  const builder = ResponseBuilder.telegram()
