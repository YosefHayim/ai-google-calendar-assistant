  ...
  describe("Subscription Endpoints", () => {
    describe("GET /api/payments/plans", () => {
      it("should return all active plans", () => {
        const plans = [
          { id: "starter", name: "Starter", price_monthly_cents: 999, is_active: true },
          { id: "pro", name: "Pro", price_monthly_cents: 1999, is_active: true },
          { id: "executive", name: "Executive", price_monthly_cents: 4999, is_active: true },
        ]
      ...
      it("should include pricing information", () => {
        ...
        expect(plan.price_yearly_cents).toBeLessThan(plan.price_monthly_cents * 12)
      })
    })
    ...
    describe("POST /api/payments/cancel", () => {
      it("should cancel subscription at period end", () => {
        const cancelRequest = { cancelAtPeriodEnd: true }
    ...
    describe("POST /api/chat/stream", () => {
      ...
      it("should validate message is not empty", () => {
        ...
        emptyMessages.forEach((msg) => {
          const isValid = msg && typeof msg === "string" && msg.trim().length > 0
