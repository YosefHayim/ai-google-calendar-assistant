    ...
    <html lang="en">
      <body className="font-sans">
        <div className="flex min-h-screen items-center justify-center bg-muted p-4 dark:bg-secondary">
          <div className="w-full max-w-lg rounded-lg border border bg-background p-6 shadow-sm dark:border dark:bg-secondary">
            ...
            <h2 className="mb-2 text-2xl font-semibold text-foreground dark:text-primary-foreground">Something went wrong</h2>
            ...
            <details className="mb-6">
              ...
              <div className="mt-3 space-y-2">
                ...
                {error.digest && <p className="text-xs text-muted-foreground dark:text-muted-foreground">Error ID: {error.digest}</p>}
              </div>
            </details>
