      ...
      <div className="py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-zinc dark:prose-invert max-w-none">
            ...
            {/* Contact Information */}
            <section className="mb-12">
              <h2 className="text-2xl font-medium text-zinc-900 dark:text-zinc-100 mb-4">2. Contact Information</h2>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-medium text-zinc-900 dark:text-zinc-100 mb-4">3. Information We Collect</h2>
            ...
            <section className="mb-12 bg-blue-50 dark:bg-blue-950/30 rounded-xl p-6 border border-blue-200 dark:border-blue-800">
              <h2 className="text-2xl font-medium text-zinc-900 dark:text-zinc-100 mb-4">4. Google User Data</h2>
              <p className="text-zinc-600 dark:text-zinc-300 leading-relaxed mb-4">
            ...
            <section className="mb-12">
              ...
              <div className="space-y-4">
                <div className="bg-zinc-50 dark:bg-zinc-900/50 rounded-lg p-4 border border-zinc-200 dark:border-zinc-800">
                  <h4 className="font-medium text-zinc-900 dark:text-zinc-100 mb-2">OpenAI</h4>
                ...
                <div className="bg-zinc-50 dark:bg-zinc-900/50 rounded-lg p-4 border border-zinc-200 dark:border-zinc-800">
                  <h4 className="font-medium text-zinc-900 dark:text-zinc-100 mb-2">Supabase</h4>
                  <p className="text-sm text-zinc-600 dark:text-zinc-300">
                ...
                <div className="bg-zinc-50 dark:bg-zinc-900/50 rounded-lg p-4 border border-zinc-200 dark:border-zinc-800">
                  <h4 className="font-medium text-zinc-900 dark:text-zinc-100 mb-2">Telegram Bot API</h4>
                  <p className="text-sm text-zinc-600 dark:text-zinc-300">
            ...
            {/* Data Retention */}
            <section className="mb-12">
              <h2 className="text-2xl font-medium text-zinc-900 dark:text-zinc-100 mb-4">7. Data Retention</h2>
              <ul className="list-disc pl-6 text-zinc-600 dark:text-zinc-300 space-y-2">
                <li>
            ...
            {/* Your Rights */}
            <section className="mb-12">
              <h2 className="text-2xl font-medium text-zinc-900 dark:text-zinc-100 mb-4">8. Your Rights</h2>
            ...
            {/* Security */}
            <section className="mb-12">
              <h2 className="text-2xl font-medium text-zinc-900 dark:text-zinc-100 mb-4">9. Security</h2>
              <p className="text-zinc-600 dark:text-zinc-300 leading-relaxed mb-4">
            ...
            {/* Contact Us */}
            <section className="mb-12">
              <h2 className="text-2xl font-medium text-zinc-900 dark:text-zinc-100 mb-4">13. Contact Us</h2>
              <p className="text-zinc-600 dark:text-zinc-300 leading-relaxed mb-4">
