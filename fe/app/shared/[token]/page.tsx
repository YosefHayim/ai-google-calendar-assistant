      ...
      <div
        className={cn(
          ...
          isUser
            ...
            : 'bg-secondary dark:bg-secondary/80 text-foreground dark:text-primary-foreground rounded-tl-md border border/50 dark:border-zinc-700/50',
        )}
      >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-zinc-50 to-white dark:from-zinc-950 dark:to-zinc-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        <div className="w-20 h-20 rounded-2xl bg-destructive/5 dark:bg-red-900/20 flex items-center justify-center mx-auto mb-6 border border-red-100 dark:border-red-900/30">
        ...
        <p className="text-muted-foreground dark:text-muted-foreground mb-8 text-base sm:text-lg leading-relaxed">{error}</p>
        <Button
          asChild
          size="lg"
...
export default function SharedConversationPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-zinc-50 via-white to-zinc-50 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950 flex flex-col">
      ...
      <header className="sticky top-0 z-20 backdrop-blur-xl bg-background/80 dark:bg-secondary/80 border-b border/80 dark:border/80">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex-1 min-w-0 sm:hidden">
              <h1 className="font-medium text-sm text-foreground dark:text-primary-foreground truncate">{conversation.title}</h1>
      ...
      <div className="hidden sm:block max-w-3xl mx-auto w-full px-4 sm:px-6 pt-6 pb-2">
        <div className="bg-background dark:bg-secondary rounded-2xl border border dark:border p-5 shadow-sm">
          <h1 className="font-semibold text-xl text-foreground dark:text-primary-foreground mb-2">{conversation.title}</h1>
      ...
      <footer className="border-t border/80 dark:border/80 bg-background/50 dark:bg-secondary/50 backdrop-blur-sm">
