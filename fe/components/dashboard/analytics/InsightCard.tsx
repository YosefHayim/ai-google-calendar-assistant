...
const InsightCard: React.FC<InsightCardProps> = ({ icon: Icon, title, value, description, color }) => {
  ...
  return (
    <div className="min-w-0 bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-md shadow-sm p-3 sm:p-4 md:p-6 flex flex-col gap-2 sm:gap-3 md:gap-4 transition-all hover:shadow-md hover:-translate-y-1">
      <div className="flex items-center gap-2 sm:gap-3 min-w-0">
        ...
        <h3 className="min-w-0 font-semibold text-zinc-600 dark:text-zinc-400 text-xs sm:text-sm line-clamp-2">{title}</h3>
      </div>
      <div>
