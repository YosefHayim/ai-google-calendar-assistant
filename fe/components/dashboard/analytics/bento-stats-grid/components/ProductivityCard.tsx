...
export function ProductivityCard({ productivityScore, meetingLoad, focusTimePercentage }: ProductivityCardProps) {
  ...
  return (
    <motion.div
      ...
      className="col-span-1 sm:col-span-2 row-span-2 bg-gradient-to-br from-background to-background dark:from-secondary/30 dark:to-secondary border-border rounded-xl p-4 sm:p-6 shadow-sm hover:shadow-md hover:border-border transition-all overflow-hidden"
    >
