...
function VisaIcon({ className }: { className?: string }) {
  return (
    <svg className={cn('h-6 w-10', className)} viewBox="0 0 48 32" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export function PaymentMethodCard({ paymentMethod, onUpdate, className }: PaymentMethodCardProps) {
    ...
    return (
      <Card className={cn('p-6', className)}>
        <div className="flex items-center justify-between">
          <div>
            <h3 className="mb-1 text-lg font-semibold text-foreground">Payment Method</h3>
  ...
  return (
    <Card className={cn('p-6', className)}>
      ...
      <div className="rounded-xl bg-gradient-to-br from-secondary to-secondary p-4 shadow-lg">
        <div className="mb-6 flex items-center justify-between">
          <CardIcon className="h-8 w-12" />
          {paymentMethod.isDefault && (
            <span className="text-xs uppercase tracking-wider text-muted-foreground">Default</span>
          )}
        </div>
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg tracking-widest text-muted-foreground">••••</span>
            <span className="text-lg tracking-widest text-muted-foreground">••••</span>
            <span className="font-mono text-lg tracking-widest text-foreground">{paymentMethod.last4}</span>
          </div>

          <div className="flex items-center justify-between">
            <div>
              <span className="block text-xs uppercase text-muted-foreground">Expires</span>
