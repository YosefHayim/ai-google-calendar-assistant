...
export const ViewSwitcher: React.FC<ViewSwitcherProps> = ({ activeTab, onTabChange }) => {
  return (
    <div className="z-30 flex flex-nowrap justify-center bg-background/80 dark:bg-secondary/80 backdrop-blur-md p-0.5 rounded-md shadow-lg border -secondary md:absolute md:top-4 md:left-1/2 md:-translate-x-1/2 md:ml-4">
      <Tooltip>
