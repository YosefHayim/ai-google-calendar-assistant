          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 text-left">
              ...
              <DialogDescription className="sr-only">
                Events and availability for {formattedDate}
              </DialogDescription>
              ...
              return (
                ...
                >
                  <HoverCardTrigger asChild>
                    ...
                    >
                      <span className="text-xs text-black truncate block px-0.5 leading-8">
                        {displayName}
                      </span>
                    </div>
                  </HoverCardTrigger>
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center p-6 text-center">
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-400">
                You have {availableHours.toFixed(1)} hours of free time this
                day.
              </p>
            </div>
          ) : (
            <ul className="space-y-2">
              {[...events]
                ...
                .map((event) => {
                  ...
                  const { name: calendarName, color: calendarColor } =
                    getCalendarInfo(event);
