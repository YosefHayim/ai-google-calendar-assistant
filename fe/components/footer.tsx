      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          <div className="lg:col-span-2">
            ...
            <p className="text-zinc-500 dark:text-zinc-400 max-w-sm mb-8 leading-relaxed">
              The executive-grade AI assistant designed for business owners to defend their deep work. From Free Exploratory access to <b>Unlimited Executive Power</b>. Built on the Ally Neural Protocol.
            </p>
            <div className="flex items-center gap-4">
              <a href="https://discord.gg" target="_blank" rel="noopener noreferrer" className="p-2 bg-zinc-100 dark:bg-zinc-900 rounded-md text-zinc-500 hover:text-primary transition-colors" title="Discord">
                <DiscordIcon className="w-5 h-5" />
              </a>
              <a href="https://t.me" target="_blank" rel="noopener noreferrer" className="p-2 bg-zinc-100 dark:bg-zinc-900 rounded-md text-zinc-500 hover:text-primary transition-colors" title="Telegram">
                <TelegramIcon className="w-5 h-5" />
              </a>
              <a href="https://wa.me" target="_blank" rel="noopener noreferrer" className="p-2 bg-zinc-100 dark:bg-zinc-900 rounded-md text-zinc-500 hover:text-primary transition-colors" title="WhatsApp">
                <WhatsAppIcon className="w-5 h-5" />
              </a>
              <a href="mailto:hello@getally.ai" className="p-2 bg-zinc-100 dark:bg-zinc-900 rounded-md text-zinc-500 hover:text-primary transition-colors" title="Email">
        ...
        <div className="pt-10 border-t border-zinc-100 dark:border-zinc-800 flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="text-xs text-zinc-400">
            © {currentYear} Ally Technologies Inc. All rights reserved.
          </p>
