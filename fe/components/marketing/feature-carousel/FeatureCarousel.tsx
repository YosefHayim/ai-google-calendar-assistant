  ...
  return (
    ...
    >
      <Button
        ...
        size="icon"
        onClick={prev}
        className="absolute left-2 lg:-left-6 top-1/2 -translate-y-1/2 z-30 rounded-full bg-background/90 dark:bg-secondary/90 backdrop-blur-sm border dark:border-zinc-700 shadow-xl text-muted-foreground hover:text-primary opacity-100 lg:opacity-0 lg:group-hover/carousel:opacity-100 hover:scale-110 active:scale-95"
      >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center bg-muted dark:bg-secondary/50 rounded-[2.5rem] border border dark:border p-8 md:p-12 lg:p-16 relative overflow-hidden">
        ...
        <div className="lg:col-span-5 flex flex-col gap-6 relative z-10">
          <div className="flex flex-col gap-4">
            <AnimatePresence mode="wait">
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl bg-background dark:bg-secondary border border dark:border-zinc-700 flex items-center justify-center shadow-sm ${FEATURES[active].color}`}
                >
