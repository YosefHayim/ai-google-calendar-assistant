            ...
            <Card className="border-2 p-3 shadow-xl">
              <div className="space-y-2">
                <div className="flex items-start justify-between gap-2">
                  ...
                  <div
                    className={cn('h-3 w-3 rounded-full flex-shrink-0', !useHexColor && colorClasses.bg)}
                    style={bgStyle}
                  />
                </div>
          ...
          <Card className="border-2 p-4 shadow-xl">
            <div className="space-y-3">
              <div className="flex items-start justify-between gap-2">
                ...
                <div
                  className={cn('h-4 w-4 rounded-full flex-shrink-0', !useHexColor && colorClasses.bg)}
                  style={bgStyle}
                />
              </div>
