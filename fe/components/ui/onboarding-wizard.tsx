...
import { X, ChevronRight, ChevronLeft, Calendar, MessageSquare, Smartphone, Zap, Check } from "lucide-react";
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm">
      ...
      <motion.div
        ...
        className="relative w-full max-w-2xl mx-4 bg-card border rounded-2xl shadow-lg overflow-hidden"
      >
        {/* Close Button */}
        <button
          onClick={handleSkip}
