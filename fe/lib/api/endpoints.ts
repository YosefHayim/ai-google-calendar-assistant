...
export const ENDPOINTS = {
   ...
   * @param id - Event ID
   */
  EVENTS_RESCHEDULE_SUGGESTIONS: (id: string) =>
    `/api/events/${id}/reschedule-suggestions`,
   ...
   */
  INTEGRATIONS_GOOGLE_CALENDAR_DISCONNECT:
    "/api/users/integrations/google-calendar/disconnect",
   ...
   * Methods: PUT
   */
  USER_PREFERENCES_CONTEXTUAL_SCHEDULING:
    "/api/users/preferences/contextual_scheduling",

  USER_PREFERENCES_REMINDER_DEFAULTS:
    "/api/users/preferences/reminder_defaults",
   ...
   * Methods: PUT
   */
  USER_PREFERENCES_CROSS_PLATFORM_SYNC:
    "/api/users/preferences/cross_platform_sync",
   ...
   */
  ADMIN_DASHBOARD_SUBSCRIPTION_TRENDS:
    "/api/admin/dashboard/subscription-trends",
   ...
   * @param id - User ID
   */
  ADMIN_USER_PASSWORD_RESET: (id: string) =>
