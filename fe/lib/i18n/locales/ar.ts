...
export const ar: TranslationShape = {
  ...
  about: {
    title: 'حول',
    subtitle: 'نبني مستقبل إدارة التقويم بذكاء اصطناعي يفهم طريقة عملك.',
    missionTitle: 'مهمتنا',
    missionP1: 'نؤمن بأن الجميع يستحق مساعداً شخصياً يفهم جدوله، ويحترم وقته، ويساعده على التركيز على الأهم.',
    missionP2:
      'يجمع Ally بين الذكاء الاصطناعي المتطور والتصميم البديهي لإنشاء تجربة تقويم تشعرك بأن لديك سكرتيراً مخصصاً.',
    activeUsers: 'مستخدمون نشطون',
    accuracyRate: 'معدل الدقة',
    userRating: 'تقييم المستخدمين',
    savedWeekly: 'يُوفّر أسبوعياً',
    valuesTitle: 'قيمنا',
    privacyFirst: 'الخصوصية أولاً',
    privacyFirstDesc: 'بياناتك ملكك. نستخدم تشفيراً رائداً ولا نبيع معلوماتك أبداً.',
    speedMatters: 'السرعة مهمة',
    speedMattersDesc: 'كل تفاعل محسّن للسرعة. جدول في ثوانٍ، وليس دقائق.',
    userFocused: 'التركيز على المستخدم',
    userFocusedDesc: 'كل ميزة نبنيها تبدأ بفهم احتياجات مستخدمينا الحقيقية.',
    ctaTitle: 'انضم إلينا في مهمتنا',
    ctaSubtitle: 'جرّب مستقبل إدارة التقويم اليوم.',
    getStarted: 'ابدأ',
  },
  ...
  testimonials: {
    badge: 'طبقة التحقق',
    title: 'موثوق من قبل أكثر المحترفين طموحاً في العالم.',
    verified: 'موثق',
    reviews: {
      alex: {
        name: 'أليكس ريفيرا',
        role: 'شريك رأس مال مخاطر',
        content:
          'أللي غيّر طريقة إدارتي لوقتي. أرسل رسالة للبوت على واتساب لمراجعة يومي، ويعيد تنظيم تقويم Google تلقائياً لتحديد أولويات نوافذ العمل العميق.',
      },
      sarah: {
        name: 'سارة تشين',
        role: 'مؤسسة منفردة',
        content:
          'التمرير عبر تيليجرام لا تشوبه شائبة. يمكنني حظر جلسات العمل العميق وحل تداخلات التقويم عبر رسالة صوتية أثناء المشي بين المواعيد. إنها حقاً تجربة مكتب خاص.',
      },
      james: {
        name: 'جيمس ويلسون',
        role: 'مستثمر خاص',
        content:
          'أخيراً استعدت صباحاتي. أللي يفهم عاداتي الإنتاجية أفضل مني، يحمي فترات تركيزي كالصقر من دعوات التقويم منخفضة القيمة.',
      },
      elena: {
        name: 'إيلينا رودريغيز',
        role: 'مستشارة قانونية رئيسية',
        content:
          'النهج الكمي لسجل وقتي كان العامل الحاسم. رؤية نسبة تركيزي وتكاليف تبديل السياق في الوقت الفعلي جعلني مديرة تنفيذية أكثر فعالية بكثير.',
      },
      marcus: {
        name: 'ماركوس ثورن',
        role: 'مدير إداري',
        content:
          'التقاط تعديلات الجدول عبر الصوت على تيليجرام غيّر سير عملي. أللي يفهم النية، وليس فقط الكلمات المفتاحية، مما يجعل حل التعارضات التلقائي موثوقاً بشكل لا يصدق.',
      },
      lila: {
        name: 'ليلا فانس',
        role: 'مستشارة استراتيجية',
        content:
          'تحليلات الذكاء تُظهر لي بالضبط أين تسربات تركيزي. زدت نسبة عملي العميق بنسبة 40% منذ أن تولى أللي جدولتي العصبية وإدارة تقويمي.',
      },
    },
  },
