...
export const ar: TranslationShape = {
  ...
  dialogs: {
    ...
    createCalendar: {
      ...
      subtitle: 'أدخل اسمًا لتقويمك الجديد. سيتم إضافته إلى حساب تقويم Google الخاص بك.',
      name: 'اسم التقويم',
      namePlaceholder: 'مثال: مشاريع العمل، أهداف شخصية، لياقة',
      description: 'الوصف',
    ...
    quickEvent: {
      title: 'إضافة حدث سريع',
      description: 'أضف حدثاً إلى تقويمك باستخدام اللغة الطبيعية أو الصوت',
      placeholder: 'صِف حدثك باللغة الطبيعية...',
      examples: 'أمثلة:',
      example1: 'اجتماع مع جون غداً الساعة 3 مساءً',
      example2: 'غداء في كافيه روما يوم الجمعة 12:30 مساءً لمدة ساعة',
      example3: 'اجتماع الفريق اليومي كل إثنين الساعة 9 صباحاً',
      recording: 'جاري التسجيل... انقر على الميكروفون للإيقاف',
      pressEnter: 'اضغط Enter للمعالجة',
      processing: 'جاري المعالجة...',
      createEvent: 'إنشاء حدث',
      ally: 'Ally',
      yourAIAssistant: 'مساعدك الذكي',
      listening: 'جاري الاستماع... انقر مرة أخرى للإيقاف.',
      listeningToYou: 'جاري الاستماع لما قلته...',
      understanding: 'جاري فهم طلبك...',
      eventAdded: 'تمت إضافة الحدث إلى تقويمك!',
      conflictDetected: 'يتعارض هذا مع أحداث موجودة.',
      creatingAnyway: 'جاري إنشاء الحدث على أي حال...',
      failedTranscribe: 'فشل في نسخ الصوت. يرجى المحاولة مرة أخرى.',
      couldNotTranscribe: 'تعذر نسخ الصوت.',
      failedCreate: 'فشل في إنشاء الحدث.',
      unexpectedConflict: 'تعارض غير متوقع',
      allowMicrophone: 'يرجى السماح بالوصول إلى الميكروفون لاستخدام الإدخال الصوتي.',
    },
  },
  ...
  chat: {
    ...
    avatarView: {
      ...
      speakOrType: 'تحدث أو اكتب للتفاعل مع Ally وإدارة تقويمك.',
      liveContext: 'سياق مباشر',
      cancelEdit: 'إلغاء (Esc)',
      confirmEdit: 'تأكيد (Enter)',
    },
  ...
  gaps: {
    ...
    actions: {
      ...
      skipGap: 'تخطي الفجوة',
      dismissAllGaps: 'تجاهل جميع الفجوات',
    },

    analytics: {
      totalPotentialHours: 'إجمالي الساعات المحتملة',
      availableForScheduling: 'متاحة للجدولة',
      averageGap: 'متوسط الفجوة',
      typicalGapSize: 'حجم الفجوة النموذجي',
      largestGap: 'أكبر فجوة',
      bestOpportunity: 'أفضل فرصة',
      analysisPeriod: 'فترة التحليل',
      to: 'إلى',
      confidenceDistribution: 'توزيع الثقة',
      confidenceDescription: 'مدى ثقة الذكاء الاصطناعي في كل اقتراح فجوة',
      highConfidence: 'ثقة عالية',
      mediumConfidence: 'ثقة متوسطة',
      lowConfidence: 'ثقة منخفضة',
      durationDistribution: 'توزيع المدة',
      durationDescription: 'تقسيم أحجام الفجوات حسب المدة',
      lessThanOneHour: '< ساعة واحدة',
      oneToTwoHours: '1-2 ساعة',
      twoOrMoreHours: '2+ ساعة',
      analysisSettings: 'إعدادات التحليل',
      settingsDescription: 'التكوين الحالي لاكتشاف الفجوات',
      minGap: 'الحد الأدنى للفجوة:',
      maxGap: 'الحد الأقصى للفجوة:',
      lookback: 'فترة المراجعة:',
      autoAnalysis: 'التحليل التلقائي:',
      enabled: 'مُفعّل',
      disabled: 'معطّل',
      calendars: 'التقويمات:',
      calendarsIncluded: '{{count}} مضمنة',
      languages: 'اللغات:',
      languagesSupported: '{{count}} مدعومة',
      days: 'أيام',
    },
  },
  ...
  settings: {
    ...
    realTimeLocationTooltip:
      'عند التمكين، يستخدم Ally موقعك الحالي لتوفير السياق لإنشاء الأحداث (مثل اقتراح الأماكن القريبة)',
    memberSince: 'عضو منذ',
  ...
  onboarding: {
    ...
    allyProtocol: 'بروتوكول Ally',
    steps: {
      welcome: {
        title: 'مرحباً بك في Ally',
        description: 'مساعد التقويم المدعوم بالذكاء الاصطناعي',
        content: 'أنا سكرتيرك الخاص بالذكاء الاصطناعي. دعنا نأخذ 30 ثانية لنريك كيف يمكنني خلق أفضلية في يومك.',
        audioText:
          'مرحباً بك في Ally، مساعد التقويم المدعوم بالذكاء الاصطناعي! أنا هنا لمساعدتك في إدارة جدولك بسهولة. دعني أريك الطريق.',
      },
      assistant: {
        title: 'مركز القيادة',
        content: 'هذه هي واجهة الدردشة الرئيسية. فوّض المهام، جدول الاجتماعات، أو اطلب ملخصات هنا.',
      },
      chat: {
        title: 'تحدث مع Ally',
        description: 'التخطيط بلغة طبيعية',
        content:
          'اكتب أو تكلم بشكل طبيعي. قل أشياء مثل "جدول اجتماع مع جون غداً الساعة الثانية مساءً" أو "ما لدي الأسبوع القادم؟" يفهم Ally السياق ويتعامل مع الطلبات المعقدة.',
        audioText:
          'واجهة الدردشة هي طريقتك الرئيسية للتفاعل معي. اكتب بشكل طبيعي، كما لو كنت ترسل رسالة لصديق. قل أشياء مثل "جدول غداء مع سارة غداً" أو "ما هي الاجتماعات لدي هذا الأسبوع؟"',
      },
      analytics: {
        title: 'ذكاء الأداء',
        content: 'تتبع نسبة العمل العميق الخاصة بك وشاهد بالضبط كم من الوقت يستعيده Ally لك.',
      },
      integrations: {
        title: 'الاتصال السلس',
        content: 'قم بربط Ally بـ WhatsApp و Telegram ومصادر التقويم الخاصة بك لمركزة عملياتك.',
      },
      settings: {
        title: 'الخصوصية والتحكم',
        content: 'إدارة إعدادات الذاكرة السياقية وتفضيلات أمان الحساب هنا.',
      },
      gaps: {
        title: 'استعادة الوقت الضائع',
        description: 'البحث عن الفجوات وملؤها في الجدول',
        content:
          'يكتشف Ally تلقائياً الوقت غير المسجل في تقويمك. راجع هذه الفجوات وأضف الأحداث بسرعة للحفاظ على سجل دقيق لأنشطتك.',
        audioText:
          'استعادة الفجوات ميزة فريدة تساعدك في تتبع أين يذهب وقتك. سأحدد الفترات التي لم يتم حسابها في تقويمك، حتى تتمكن من ملؤها والحفاظ على جدول دقيق.',
      },
      complete: {
        title: 'أنت جاهز!',
        description: 'ابدأ في إدارة تقويمك',
        content:
          'أنت جاهز لاستخدام Ally! تذكر، يمكنك دائماً الوصول إلى الإعدادات لتخصيص تجربتك، ربط تقاويم إضافية، أو تعديل تفضيلات الإشعارات.',
        audioText:
          'تهانينا! أنت جاهز لبدء استخدام Ally. إذا احتجت مساعدة في أي وقت، فقط اسألني. أنا هنا لجعل إدارة تقويمك سهلة. دعنا نبدأ!',
      },
    },
  },
  ...
  toast: {
    ...
    waitingList: {
      ...
      titlePart2: 'يستمع.',
      subtitle:
        'قلها ببساطة. يجدولها آلي. عبر الصوت، الدردشة، تيليجرام، وواتساب. لا نماذج. لا احتكاك. فقط أنت ووقتك، أخيراً تعملان معاً.',
  ...
  ui: {
    ...
    executiveGradeAI:
      'مساعد الذكاء الاصطناعي من الدرجة التنفيذية المصمم لأصحاب الأعمال لحماية عملهم العميق. من الوصول الاستكشافي المجاني إلى القوة التنفيذية غير المحدودة. مبني على بروتوكول ألي العصبي.',
    systemOnline: 'جميع الأنظمة تعمل',
    systemOffline: 'النظام غير متاح',
  ...
  integrations: {
    ...
    googleCalendar: {
      ...
      description: 'زامن تقويماتك مع Ally للجدولة السلسة وحل التعارضات.',
      failedToLoad: 'فشل في تحميل بيانات التقويم.',
      fetchingCalendars: 'جاري جلب التقويمات...',
      syncedSources: 'المصادر المتزامنة',
      manage: 'إدارة',
      tryAgain: 'حاول مرة أخرى',
      apiActive: 'API نشط',
      unnamed: 'تقويم بدون اسم',
    ...
    whatsappModalDescription: 'لربط WhatsApp، يرجى اتباع التعليمات في وحدة تحكم Ally Node.',
