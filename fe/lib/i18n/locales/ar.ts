  ...
  onboarding: {
    ...
    steps: {
      welcome: {
        ...
        content:
          'يساعدك Ally في إدارة تقويمك بسهولة باستخدام اللغة الطبيعية. فقط أخبر Ally بما تحتاجه، وسيتولى الباقي.',
        audioText:
      ...
      analytics: {
        title: 'تتبع وقتك',
        description: 'رؤى حول جدولك',
        content:
          'عرض تحليلات مفصلة حول كيفية قضاء وقتك. فهم أنماط اجتماعاتك، العثور على فرص للتحسين، والحفاظ على توازن صحي بين العمل والحياة.',
        audioText:
          'لوحة التحليلات تمنحك رؤى قوية حول كيفية قضاء وقتك. تتبع أنماط الاجتماعات، تحديد الفترات المزدحمة، وتحسين جدولك لإنتاجية أفضل.',
      },
      gaps: {
