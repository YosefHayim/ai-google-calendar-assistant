...
export const fr: TranslationShape = {
  ...
  about: {
    heroBadge: 'Le coût caché du chaos',
  ...
  sidebar: {
    ...
    calendars: 'Agendas',
    calendarsDescription: 'Gérez vos sources Google Agenda et créez de nouveaux agendas',
    activity: 'Activité',
    activityDescription: "Consultez l'historique de vos conversations et interactions passées avec Ally",
    telegram: 'Telegram',
    telegramDescription: 'Connectez et gérez votre intégration du bot Telegram',
    account: 'Compte',
    accountDescription: 'Gérez votre profil, services connectés et paramètres du compte',
    settings: 'Paramètres',
    logout: 'Déconnexion',
  ...
  testimonials: {
    ...
    subtitle: 'Découvrez ce que pensent nos premiers utilisateurs. Vos commentaires pourraient être ici aussi!',
    cta: 'Soyez parmi les premiers',
    feedbackButton: 'Partagez vos commentaires',
    featured: {
      name: 'Yosef Sabag',
      role: 'PDG',
      content:
