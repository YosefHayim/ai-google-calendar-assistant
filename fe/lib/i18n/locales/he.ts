  ...
  onboarding: {
    ...
    steps: {
      welcome: {
        ...
        content: 'אלי עוזר לך לנהל את היומן שלך בקלות באמצעות שפה טבעית. פשוט אמור לאלי מה אתה צריך, והוא יטפל בכל השאר.',
        audioText: 'ברוך הבא לאלי, העוזר החכם שלך ליומן! אני כאן כדי לעזור לך לנהל את לוח הזמנים שלך בקלות. תן לי להראות לך סביב.',
      },
      chat: {
        title: 'שוחח עם אלי',
        description: 'תזמון בשפה טבעית',
        content: 'פשוט הקלד או דבר באופן טבעי. אמור דברים כמו "קבע פגישה עם ג׳ון מחר בשעה 2" או "מה יש לי בשבוע הבא?" אלי מבין הקשר ומטפל בבקשות מורכבות.',
        audioText: 'ממשק הצ\'אט הוא הדרך העיקרית שלך להתקשר איתי. פשוט הקלד באופן טבעי, כמו שאתה שולח הודעה לחבר. אמור דברים כמו "קבע ארוחת צהריים עם שרה מחר" או "אילו פגישות יש לי השבוע?"',
      },
      analytics: {
        title: 'עקוב אחר הזמן שלך',
        description: 'תובנות ללוח הזמנים שלך',
        content: 'צפה באנליטיקות מפורטות על איך אתה מבלה את הזמן שלך. הבן את דפוסי הפגישות שלך, מצא הזדמנויות לייעול, ושמור על איזון בריא בין עבודה לחיים.',
        audioText: 'לוח המחוונים של האנליטיקות נותן לך תובנות רבות עוצמה על איך אתה מבלה את הזמן שלך. עקוב אחר דפוסי פגישות, זהה תקופות עמוסות, וייעל את לוח הזמנים שלך לפרודוקטיביות טובה יותר.',
      },
      gaps: {
        title: 'החזר זמן אבוד',
        description: 'מצא ומלא פערים בלוח הזמנים',
        content: 'אלי מזהה באופן אוטומטי זמן לא מתועד ביומן שלך. בדוק את הפערים האלה והוסף אירועים במהירות כדי לשמור על רישום מדויק של הפעילויות שלך.',
        audioText: 'שחזור פערים הוא תכונה ייחודית שעוזרת לך לעקוב לאן הזמן שלך הולך. אני אזהה תקופות שלא מחושבות ביומן שלך, כדי שתוכל למלא אותן ולשמור על לוח זמנים מדויק.',
      },
      complete: {
        title: 'אתה מוכן!',
        description: 'התחל לנהל את היומן שלך',
        content: 'אתה מוכן להשתמש באלי! זכור, אתה תמיד יכול לגשת להגדרות כדי להתאים אישית את החוויה שלך, לחבר יומנים נוספים, או להתאים העדפות התראות.',
        audioText: 'מזל טוב! אתה מוכן להתחיל להשתמש באלי. אם אי פעם תצטרך עזרה, פשוט שאל אותי. אני כאן כדי להפוך את ניהול היומן שלך לקל. בואו נתחיל!',
      },
    },
  },
  ...
  billing: {
    ...
    toast: {
      ...
      waitingList: {
        ...
        titlePart2: 'מקשיב.',
        subtitle: 'פשוט אמור זאת. אלי מתזמן זאת. בכל מקום - קול, צ\'אט, טלגרם וואטסאפ. ללא טפסים. ללא חיכוך. רק אתה והזמן שלך, סוף סוף עובדים יחד.',
