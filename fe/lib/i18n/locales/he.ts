...
export const he: TranslationShape = {
  ...
  home: {
    ...
    telegramDescription:
      'נהל את היומן שלך בדרכים. שלח הודעות קוליות, תזמן אירועים וקבל תזכורות — הכל מטלגרם.',
  ...
  showcase: {
    ...
    today: {
      ...
      description:
        'קבל סקירה מלאה של היום שלך עם /today. צפה בכל הפגישות, בלוקי מיקוד וזמן פנוי במבט אחד.',
    },
    voice: {
      title: 'פקודות קוליות',
      description:
        'שלח הודעות קוליות לניהול היומן ללא ידיים. אלי מתמללת ומבצעת את הבקשות שלך מיד.',
    },
    analytics: {
      title: 'אנליטיקת זמן',
      description:
    ...
    brain: {
      title: 'מוח אלי',
      description:
        'למד את אלי את ההעדפות שלך עם /brain. הגדר כללים כמו "אין פגישות לפני 10 בבוקר" ואלי תזכור.',
    },
    search: {
      title: 'חיפוש חכם',
      description:
        'מצא פגישות קודמות מיד. שאל "מתי נפגשתי עם שרה לאחרונה?" וקבל תשובות מדויקות עם הקשר.',
    },
    create: {
      title: 'יצירה מהירה',
      description:
        'תזמן אירועים בשפה טבעית. פשוט אמור "ארוחת צהריים עם אלכס מחר בצהריים" ואשר.',
    },
    language: {
      title: 'רב-לשוני',
      description:
        'השתמש באלי בשפה המועדפת עליך עם /language. תומך באנגלית, עברית, רוסית, צרפתית, גרמנית וערבית.',
    },
  },
  ...
  testimonials: {
    badge: 'שכבת אימות',
    title: 'מהימן על ידי בעלי הביצועים הגבוהים והשאפתניים ביותר בעולם.',
    verified: 'מאומת',
    reviews: {
      alex: {
        name: 'אלכס ריברה',
        role: 'שותף הון סיכון',
        content:
          'אלי שינתה את האופן שבו אני מנהל את הזמן שלי. אני פשוט שולח הודעה לבוט בווטסאפ כדי לבדוק את היום שלי, והיא מסדרת מחדש אוטומטית את יומן Google שלי כדי לתעדף את חלונות העבודה העמוקה שלי.',
      },
      sarah: {
        name: 'שרה צ׳ן',
        role: 'מייסדת יחידה',
        content:
          'הממסר בטלגרם מושלם. אני יכולה לחסום זמני עבודה עמוקה ולפתור חפיפות ביומן באמצעות הודעה קולית תוך כדי הליכה בין פגישות. זו באמת חוויית משרד פרטי.',
      },
      james: {
        name: 'ג׳יימס וילסון',
        role: 'משקיע פרטי',
        content:
          'סוף סוף החזרתי את הבקרים שלי. אלי מבינה את הרגלי הפרודוקטיביות שלי טוב ממני, מגנה על בלוקי המיקוד שלי כמו נץ מהזמנות יומן בעלות ערך נמוך.',
      },
      elena: {
        name: 'אלנה רודריגז',
        role: 'יועצת משפטית ראשית',
        content:
          'הגישה הכמותית לפנקס הזמן שלי הייתה הגורם המכריע. לראות את יחס המיקוד ועלויות החלפת ההקשר בזמן אמת הפך אותי למנהלת הרבה יותר יעילה.',
      },
      marcus: {
        name: 'מרקוס ת׳ורן',
        role: 'מנהל',
        content:
          'לכידת התאמות לוח זמנים באמצעות קול בטלגרם שינתה את זרימת העבודה שלי. אלי מבינה כוונה, לא רק מילות מפתח, מה שהופך את פתרון הסכסוכים האוטומטי לאמין להפליא.',
      },
      lila: {
        name: 'לילה ואנס',
        role: 'יועצת אסטרטגיה',
        content:
          'ניתוח המודיעין מראה לי בדיוק היכן דליפות המיקוד שלי. הגדלתי את יחס העבודה העמוקה שלי ב-40% מאז שאלי לקחה על עצמה את התזמון העצבי וניהול היומן שלי.',
      },
    },
  },
  ...
  billing: {
    ...
    trial: {
      daysLeft: '{{days}} ימים נותרו בתקופת הניסיון',
