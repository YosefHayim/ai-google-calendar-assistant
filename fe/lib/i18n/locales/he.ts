...
export const he: TranslationShape = {
  ...
  about: {
    ...
    visionP1: 'בנינו את אלי כי אנחנו מאמינים שהיומן שלך צריך לעבוד בשבילך, לא נגדך. הוא צריך להגן על העדיפויות שלך, לא רק לתעד אותן.',
    visionP2: 'אותה טכנולוגיית AI שמפעילה פתרונות ארגוניים צריכה להיות זמינה לכל בעל עסק, מנהל ואיש מקצוע שמעריך את הזמן שלו.',
    ...
    differencePrivacyDesc: 'הנתונים שלך מוצפנים, לעולם לא נמכרים, ולעולם לא משמשים לאימון מודלי AI. המשרד הפרטי שלך נשאר פרטי.',
    differenceMultiPlatform: 'עובד איפה שאתה עובד',
    differenceMultiPlatformDesc: 'אינטרנט, קול, טלגרם, וואטסאפ. אלי זמינה בכל מקום שאתה נמצא, בכל דרך שאתה מעדיף לתקשר.',
    differenceProactive: 'פרואקטיבי, לא פסיבי',
    differenceProactiveDesc: 'אלי לא רק מתעדת את לוח הזמנים שלך. היא מגינה על הזמן שלך, מציעה אופטימיזציות, ומטפלת בקונפליקטים אוטומטית.',
