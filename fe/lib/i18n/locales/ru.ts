...
export const ru: TranslationShape = {
  ...
  billing: {
    ...
    confirm: {
      cancelSubscription: 'Вы уверены, что хотите отменить подписку? Доступ сохранится до конца расчётного периода.',
      requestRefund: 'Вы уверены, что хотите запросить возврат? Подписка будет отменена немедленно.',
