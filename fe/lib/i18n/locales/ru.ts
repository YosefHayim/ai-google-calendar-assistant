...
export const ru: TranslationShape = {
  ...
  toast: {
    ...
    integrationUpdateFailed: 'Не удалось обновить настройку',
    ...
    memoryManagementUpdateFailed: 'Не удалось обновить настройку',

    // Chat
    allyResponded: 'Али ответила',
    memoryUpdated: 'Память обновлена',
    regeneratingResponse: 'Перегенерация ответа...',
    ...
    shareLinkCopied: 'Ссылка для поделиться скопирована в буфер обмена',
    shareLinkCreateFailed: 'Не удалось создать ссылку для поделиться',
    ...
    voicePreferenceUpdateFailed: 'Не удалось обновить голосовую настройку',
    ...
    // Admin
    userImpersonationFailed: 'Не удалось выдать себя за пользователя',
    ...
    billingPortalOpenFailed: 'Не удалось открыть портал биллинга',
    checkoutProcessFailed: 'Не удалось обработать оплату. Пожалуйста, попробуйте еще раз.',
    redirectingToCheckout: 'Перенаправление к оплате для настройки биллинга...',
  ...
  ui: {
    ...
    noInvoiceAvailable: 'Счет не доступен',
    ...
    noActiveCalendarSourcesFound: 'Не найдено активных источников календаря.',
    connectWhatsApp: 'Подключить WhatsApp',
    neuralLinks: 'Нейронные связи',
    executiveGradeAI: 'ИИ-ассистент исполнительного уровня, разработанный для владельцев бизнеса, чтобы защищать их глубокую работу. От бесплатного исследовательского доступа до неограниченной исполнительной власти. Построен на протоколе Ally Neural.',
    systemOnline: 'Все системы работают',
    systemOffline: 'Система недоступна',
    systemChecking: 'Проверка статуса...',
    chatOnTelegram: 'Чат с Ally в Telegram',
  ...
  integrations: {
    ...
    whatsapp: {
      title: 'WhatsApp',
      description: 'Синхронизируйте Ally с WhatsApp для безопасной передачи сообщений.',
      connect: 'Подключить',
    },
    slack: {
      title: 'Slack',
      description: 'Добавьте Ally в свое Slack-пространство для управления командным календарем.',
    },
    googleCalendar: {
      title: 'Google Calendar',
      failedToLoad: 'Не удалось загрузить данные календаря.',
      noSources: 'Не найдено активных источников календаря.',
    },
    status: {
  ...
  admin: {
    grantCredits: {
      ...
      description: 'Добавить кредиты на аккаунт {{user}}',
      ...
      auditNote: 'Это будет записано для целей аудита',
      cancel: 'Отмена',
