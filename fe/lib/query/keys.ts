...
export const queryKeys = {
  ...
  calendars: {
    ...
    list: (custom: boolean) =>
      [...queryKeys.calendars.lists(), { custom }] as const,
    ...
    settingsById: (id: string) =>
      [...queryKeys.calendars.settings(), id] as const,
  ...
  events: {
    ...
    detail: (id: string, calendarId?: string) =>
      [...queryKeys.events.details(), id, { calendarId }] as const,
    analytics: (params?: EventQueryParams) =>
      [...queryKeys.events.all, "analytics", params ?? {}] as const,
  },
} as const;
