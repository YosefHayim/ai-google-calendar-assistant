        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
`script-src 'self' 'unsafe-inline' ${isDev && "'unsafe-eval'"} https://accounts.google.com https://www.googletagmanager.com https://lmsqueezy.com`,"style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
