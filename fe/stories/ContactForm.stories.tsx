...
export const FormFields: Story = {
  render: () => (
    <div className="space-y-8">
      <div className="p-6 bg-muted dark:bg-secondary rounded-lg">
  ...
  render: () => (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-foreground dark:text-primary-foreground mb-4">Get in Touch</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          <div className="p-6 bg-muted dark:bg-secondary rounded-lg">
            ...
            <p className="text-muted-foreground dark:text-muted-foreground text-sm">support@askally.ai</p>
          </div>
          <div className="p-6 bg-muted dark:bg-secondary rounded-lg">
            <h3 className="font-semibold text-zinc-800 dark:text-zinc-200 mb-2">Response Time</h3>
            <p className="text-muted-foreground dark:text-muted-foreground text-sm">Usually within 24 hours</p>
          </div>
          <div className="p-6 bg-muted dark:bg-secondary rounded-lg">
