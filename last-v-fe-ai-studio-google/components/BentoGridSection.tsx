...
const features = [
  {
    ...
    description: "Ally automatically shields your most important work blocks from interruptions by intelligently rescheduling conflicts.",
    href: "/about",
    cta: "Learn more",
    background: (
  ...
  },
  {
    ...
    description: "Priorities change. Ally makes it easy to adjust your schedule on the fly without the usual back-and-forth.",
    href: "/dashboard",
  ...
  },
  {
    ...
    background: (
      <div className="absolute inset-0 flex items-center justify-center overflow-hidden">
        <RotatingEarth width={320} height={320} className="opacity-40 grayscale group-hover:grayscale-0 transition-all duration-700" hideControls={true} />
