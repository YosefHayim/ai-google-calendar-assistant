  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <h2 className={cn(
          "flex items-center gap-3 text-xl font-medium capitalize z-10",
          getPrimaryTextColor()
        )}>
          {tier.name}
          {isPopular && (
        ...
        <div className="flex-1 space-y-4 z-10">
          ...
          <h3 className={cn(
            "text-sm font-medium opacity-90 leading-relaxed",
            getSecondaryTextColor()
          )}>
            {tier.description}
          </h3>
            ...
            {tier.features
              ...
              >
                <BadgeCheck className={cn(
                  "h-4 w-4 shrink-0",
                  isHighlighted ? "text-white dark:text-zinc-950" : "text-primary"
                )} />
        ...
        <Button
          variant={isHighlighted ? "ghost" : "default"}
          className={cn(
            "w-full z-10 font-bold h-12",
            isHighlighted 
              ? "bg-white text-zinc-950 hover:bg-white/90 dark:bg-zinc-950 dark:text-white dark:hover:bg-zinc-900" 
              : ""
          )}
        >
          <span>{isPerUse ? "Buy Credit Pack" : tier.cta}</span>
